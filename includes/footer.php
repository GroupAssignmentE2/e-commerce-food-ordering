<footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5>About</h5>
                    <p>Experience the convenience of ordering your favorite meals online with our seamless E-Commerce Food Ordering platform—fresh, fast, and delivered to your door.</p>
                </div>
                <div class="col-md-4">
                    <h5>Links</h5>
                    <ul>
                ...
                <div class="col-md-4">
                     ...
                     <ul>
                         <li>
                            <a href="tel:+855123456789"><i class="fa fa-phone"></i> 0123456789</a>
                        </li>
                        <li>
