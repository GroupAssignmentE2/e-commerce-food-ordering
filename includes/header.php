...
<head>
    ...
    <title>Food Ordering E-commerce Store</title>
    <meta charset="utf-8">
        ...
        <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-transparent" id="page-navigation">
            <div class="container">
                ...
                <a href="<?php echo APPURL; ?>" class="navbar-brand">
                    <img src="<?php echo APPURL;?>/assets/img/logo/food-ordering.png" alt="">
                </a>
                        ...
                        <?php else : ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo APPURL;?>/products/cart.php" class="nav-link" data-toggle="" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-shopping-basket"></i> <span class="cart-count badge badge-primary"><?php echo $num->num_products; ?></span>
                                </a>
